	...
	<div id='smf_form'>
		<form>
			<div class="sm_name_div">
				<input disabled type='text' id='sm_input' class='sm_field' name='sm_name' placeholder='ENTER NAME' required >
			</div>
			<div class="sm_email_div">
				<input disabled type='email' id='sm_input' class='sm_field' name='sm_email' placeholder='ENTER EMAIL' required >
			</div>
